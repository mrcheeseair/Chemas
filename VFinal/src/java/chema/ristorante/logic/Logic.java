package chema.ristorante.logic;

import chema.ristorante.database.DatabaseX;
...
public class Logic 
{
    ...
    {
        //delete from chemas.cliente where id=0;
        DatabaseX database = getDatabase();
        String strSql = "delete from chemas."+p_strTableName+" "
                + "where id="+p_iId+" ";
