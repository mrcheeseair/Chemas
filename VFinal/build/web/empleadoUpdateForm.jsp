...
.button:hover {
    ...
    <body>
        ...
        <center><form id="myform" style="font-size:20pt;font-family:arial;"name="myform" action="EmpleadoServlet" method="get">
            ...
            <label style="border-radius: 10px;padding: 5px; display:inline;  background-color: white;">Fecha de nacimiento:</label><br>
   ...
   selected> "<%= CEmpleado.getSexo() %>"
            ...
            <label style="border-radius: 10px;padding: 5px; display:inline;  background-color: white;">DUI (sin guiones):</label><br>
