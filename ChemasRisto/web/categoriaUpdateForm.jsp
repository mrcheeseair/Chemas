...
.button:hover {
    ...
    <body>
       ...
       <center><h1 style="border-radius: 15px;font-family:arial;font-size:35px; display:inline; padding:10px; background-color: white;">  Actualizar categoria  </h1></center>
       <br><br>
        
        <center><form id="myform" name="myform" action="CategoriaServlet" method="get">
            <label>Id:</label><br>
