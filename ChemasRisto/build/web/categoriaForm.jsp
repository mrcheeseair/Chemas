...
#inventario th {
    ...
    %>
    <body>
        <a href="categoriaNew.html" class="button" style="position: absolute; right: 0;">Agregar categoria</a>
    ...
    <center><h2><a href="index.html"><img src="Images/1.png" alt="Logo" style="margin-top:0px;width:215px;height:125px;"></a></h2></center>
        <br><br>
        <center><h1 style="border-radius: 15px;font-family:arial;font-size:35px; display:inline; padding:10px; background-color: white;">Categorias</h1>  
            <br><br>
