...
.button:hover {
    ...
    <body>
        ...
        <center><h1 style="border-radius: 15px;font-family:arial;font-size:35px; display:inline; padding:5px; background-color: white;">  Actualizar detalle de orden  </h1></center>
       <br>
        <center><form id="myform" style="font-size:20pt;font-family:arial;" name="myform" action="DetalleServlet" method="get">
            <label>Id:</label><br>
            <input type="number" id="nonId" name="nonId" value="<%= CDetalle.getId() %>" disabled/>
            <br><br>
            ...
            <input type="hidden" id="id" name="id" value="<%= CDetalle.getId() %>" />
        </form>
    </body>
</html>
